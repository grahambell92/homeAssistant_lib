...
tmux new-session -d -s homeAssistant './homeAssistant_local/startHomeAssistant.sh' & #
# start the mqtt publisher (local)
tmux new-session -d -s mqtt 'python3 ./homeAssistant_local/example_publisher.py' &
