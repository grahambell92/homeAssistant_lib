...
/usr/bin/tmux new-session -d -s imgAcquirer '/usr/bin/python3 02_run_rpiZero_imgAcquirer.py' &
/usr/bin/tmux new-session -d -s rpi_zero_mqtt '/usr/bin/python3 03_mqtt_alivePublish.py' &
